...
(test-case
  ...
  (let* ([tx-data ""]
    ...
    (check-equal? (list-ref (transaction-inputs decoded) 2)
    ...
    (check-equal? (list-ref (transaction-outputs decoded) 1)
                  (output #"\0c\0" 17708900))
    (check-equal? (transaction-lock-time decoded) 700591787)))
    

(test-case
    "Native P2WPKH - unsigned tx example from bip0143"
  (let* ([tx-data ""]
    ...
    (let* ([inputs (transaction-inputs decoded)]
      ...
      (check-equal? (outpoint-transaction-hash (input-point s)) (hex-string->bytes "fff7f7881a8099afa6940d42d1e7f6362bec38171ea3edf433541db4e4ad969f"))
