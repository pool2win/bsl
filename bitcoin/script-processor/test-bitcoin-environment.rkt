...
(module+ test
  (test-case
    ...
    (let ([bitcoin-env (make-bitcoin-environment)])
      ...
      (let-values ([(script stack altstack verified) (apply-opcode 'op_if '(#x4c 2 #"AA" #x4c 3 #"AAA" op_endif) bitcoin-env '(1 blah) '())])
        (check-equal? script '())
        (check-equal? stack '(#"AAA" #"AA" blah)))
      (let-values ([(script stack altstack verified) (apply-opcode 'op_if '(#x4c 2 #"AA" #x4c 3  #"AAA" op_endif) bitcoin-env '(0 blah) '())])
        (check-equal? script '())
        (check-equal? stack '(blah)))
      (let-values ([(script stack altstack verified) (apply-opcode 'op_if '(#x4c 2 #"AA" #x4c 3  #"AAA" op_else #x4c 2 #"BB" #x4c 3  #"BBB" op_endif) bitcoin-env '(1 blah) '())])
        (check-equal? script '())
        (check-equal? stack '(#"AAA" #"AA" blah)))
      (let-values ([(script stack altstack verified) (apply-opcode 'op_if '(#x4c 2 #"AA" #x4c 3  #"AAA" op_else #x4c 2 #"BB" #x4c 3  #"BBB" op_endif) bitcoin-env '(0 blah) '())])
        (check-equal? script '())
        (check-equal? stack '(#"BBB" #"BB" blah)))
      (let-values ([(script stack altstack verified) (apply-opcode 'op_notif '(#x4c 2 #"AA" #x4c 3  #"AAA" op_endif) bitcoin-env '(0 blah) '())])
        (check-equal? script '())
        (check-equal? stack '(#"AAA" #"AA" blah)))
      (let-values ([(script stack altstack verified) (apply-opcode 'op_notif '(#x4c 2 #"AA" #x4c 3  #"AAA" op_endif) bitcoin-env '(1 blah) '())])
        (check-equal? script '())
        (check-equal? stack '(blah)))
      (let-values ([(script stack altstack verified) (apply-opcode 'op_notif '(#x4c 2 #"AA" #x4c 3  #"AAA" op_else #x4c 2 #"BB" #x4c 3  #"BBB" op_endif) bitcoin-env '(0 blah) '())])
        (check-equal? script '())
        (check-equal? stack '(#"AAA" #"AA" blah)))
      (let-values ([(script stack altstack verified) (apply-opcode 'op_notif '(#x4c 2 #"AA" #x4c 3  #"AAA" op_else #x4c 2 #"BB" #x4c 3  #"BBB" op_endif) bitcoin-env '(1 blah) '())])
        (check-equal? script '())
        (check-equal? stack '(#"BBB" #"BB" blah)))
      (let-values ([(script stack altstack verified) (apply-opcode 'op_if '(op_if #x4c 2 #"ZZ" op_endif op_else #x4c 2 #"BB" #x4c 3  #"BBB" op_endif) bitcoin-env '(1 1 blah) '())])
        (check-equal? script '())
