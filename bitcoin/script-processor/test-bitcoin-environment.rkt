...
(module+ test
  (test-case
    ...
    (let ([bitcoin-env (make-bitcoin-environment)])
      ...
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_if '(#x4c 2 #"AA" #x4c 3  #"AAA" op_endif) bitcoin-env '(0 blah) '() '())])
        (check-equal? script '())
        (check-equal? stack '(blah)))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_if '(#x4c 2 #"AA" #x4c 3  #"AAA" op_else #x4c 2 #"BB" #x4c 3  #"BBB" op_endif) bitcoin-env '(1 blah) '() '())])
        (check-equal? script '())
        (check-equal? stack '(#"AAA" #"AA" blah)))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_if '(#x4c 2 #"AA" #x4c 3  #"AAA" op_else #x4c 2 #"BB" #x4c 3  #"BBB" op_endif) bitcoin-env '(0 blah) '() '())])
        (check-equal? script '())
        (check-equal? stack '(#"BBB" #"BB" blah)))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_notif '(#x4c 2 #"AA" #x4c 3  #"AAA" op_endif) bitcoin-env '(0 blah) '() '())])
        (check-equal? script '())
        (check-equal? stack '(#"AAA" #"AA" blah)))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_notif '(#x4c 2 #"AA" #x4c 3  #"AAA" op_endif) bitcoin-env '(1 blah) '() '())])
        (check-equal? script '())
        (check-equal? stack '(blah)))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_notif '(#x4c 2 #"AA" #x4c 3  #"AAA" op_else #x4c 2 #"BB" #x4c 3  #"BBB" op_endif) bitcoin-env '(0 blah) '() '())])
        (check-equal? script '())
        (check-equal? stack '(#"AAA" #"AA" blah)))
      ...
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_verify '() bitcoin-env '(0) '() '())])
          (check-equal? verified #f))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_return '(#"AAA" #"BBB") bitcoin-env '(0) '() '())])
        (check-equal? stack '(0))
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #f))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_toaltstack '(#"AAA" #"BBB") bitcoin-env '(0) '() '())])
        (check-equal? stack '())
        (check-equal? altstack '(0))
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_fromaltstack '(#"AAA" #"BBB") bitcoin-env '(0) '(1) '())])
      ...
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_ifdup '(#"AAA" #"BBB") bitcoin-env '(1) '() '())])
        ...
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_ifdup '(#"AAA" #"BBB") bitcoin-env '(0 1) '() '())])
        (check-equal? stack '(0 1))
        (check-equal? altstack '())
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_depth '(#"AAA" #"BBB") bitcoin-env '(0 1) '() '())])
        (check-equal? stack '(2 0 1))
        (check-equal? altstack '())
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_drop '(#"AAA" #"BBB") bitcoin-env '(0 1) '() '())])
        (check-equal? stack '(1))
        (check-equal? altstack '())
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_drop '(#"AAA" #"BBB") bitcoin-env '() '() '())])
        ...
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_dup '(#"AAA" #"BBB") bitcoin-env '(0 1) '() '())])
      ...
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_dup '(#"AAA" #"BBB") bitcoin-env '() '() '())])
        ...
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_nip '(#"AAA" #"BBB") bitcoin-env '(0 1) '() '())])
        (check-equal? stack '(0))
        (check-equal? altstack '())
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_nip '(#"AAA" #"BBB") bitcoin-env '() '() '())])
        ...
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_over '(#"AAA" #"BBB") bitcoin-env '(0 1 2 3) '() '())])
      ...
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_roll '(#"AAA" #"BBB") bitcoin-env '(2 a b c d) '() '())])
        ...
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_roll '(#"AAA" #"BBB") bitcoin-env '(0 a b c d) '() '())])
      ...
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_abs '(#"AAA" #"BBB") bitcoin-env '() '() '())])
        ...
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_not '(#"AAA" #"BBB") bitcoin-env '(0 100) '() '())])
      ...
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_not '(#"AAA" #"BBB") bitcoin-env '() '() '())])
        ...
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_0notequal '(#"AAA" #"BBB") bitcoin-env '(0 100) '() '())])
        (check-equal? stack '(0 100))
        (check-equal? altstack '())
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      ...
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_booland '(#"AAA" #"BBB") bitcoin-env '(a b c) '() '())])
        ...
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_booland '(#"AAA" #"BBB") bitcoin-env '(0 0 c) '() '())])
      ...
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_boolor '(#"AAA" #"BBB") bitcoin-env '(a 0 c) '() '())])
        (check-equal? stack '(1 c))
        (check-equal? altstack '())
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_boolor '(#"AAA" #"BBB") bitcoin-env '(0 0 c) '() '())])
        (check-equal? stack '(0 c))
        (check-equal? altstack '())
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      ...
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_numequal '(#"AAA" #"BBB") bitcoin-env '(10 10 c) '() '())])
        ...
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_numequal '(#"AAA" #"BBB") bitcoin-env '(0 1 c) '() '())])
        (check-equal? stack '(0 c))
        (check-equal? altstack '())
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      ...
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_numequalverify '(#"AAA" #"BBB") bitcoin-env '(10 10 c) '() '())])
        ...
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_numequalverify '(#"AAA" #"BBB") bitcoin-env '(0 1 c) '() '())])
        (check-equal? stack '(c))
        (check-equal? altstack '())
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #f))
      ...
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_numnotequal '(#"AAA" #"BBB") bitcoin-env '(10 10 c) '() '())])
        ...
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
      (let-values ([(script stack altstack condstack verified) (apply-opcode 'op_numnotequal '(#"AAA" #"BBB") bitcoin-env '(0 1 c) '() '())])
        (check-equal? stack '(1 c))
        (check-equal? altstack '())
        (check-equal? script '(#"AAA" #"BBB"))
        (check-equal? verified #t))
  ...
  (test-case
    ...
    (let ([bitcoin-env (make-bitcoin-environment)])
      (let-values ([(script stack altstack condstack verified)
                    (eval-script '(op_if #x4c 2 #"AA" #x4c 3 #"AAA" op_else #x4c 2 #"BB" #x4c 3 #"BBB" op_endif) bitcoin-env '(0 blah) '())])
        (check-equal? script '())
        (check-equal? stack '(#"BBB" #"BB" blah)))
      (let-values ([(script stack altstack condstack verified)
                    (eval-script '(op_if #x4c 2 #"AA" #x4c 3 #"AAA" op_else #x4c 2 #"BB" #x4c 3 #"BBB" op_endif #x4c 3 #"CCC") bitcoin-env '(0 blah) '())])
        (check-equal? script '())
      ...
      (let-values ([(script stack altstack condstack verified)
        ...
        (check-equal? stack '(#"BBB" #"BB" blah)))
      (let-values ([(script stack altstack condstack verified)
                    (eval-script '(op_notif #x4c 2 #"AA" #x4c 3 #"AAA" op_else #x4c 2 #"BB" #x4c 3 #"BBB" op_endif) bitcoin-env '(0 blah) '())])
        (check-equal? script '())
        (check-equal? stack '(#"AAA" #"AA" blah)))
      (let-values ([(script stack altstack condstack verified)
      ...
      (let-values ([(script stack altstack condstack verified)
                    (eval-script '(op_if #x4c 2 #"AA" #x4c 3 #"AAA" op_endif) bitcoin-env '(0 blah) '())])
        (check-equal? script '())
        (check-equal? stack '(blah)))
      )))
