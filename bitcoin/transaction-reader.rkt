...
(module+ test
  (test-case "parse transaction from bytes"
    (let* ([tx-data
      ...
      (check-equal? outputs (list (output '(83 83 0 81 99 82 81 81) 82650789) (output '(0 99 0) 17708900)))
    ...
    (let* ([tx-data
      ...
      (check-equal? (transaction-outputs tx)
                    (list (output  '(83 83 0 81 99 82 81 81) 82650789) (output '(0 99 0) 17708900)))
